                ...
                <Modal.Body>
                    <div className='question'>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div>
                                <div>What type of activities do you want to experience on this trip?</div>
                                <input id="answer1" type="text" ></input>
                            </div>
                            <div>
                                <div>Which location do you prefer to to explore other than the current location of the trip?</div>
                                <input id="answer2" type="text" ></input>
                            </div>
                            <div>
                                <div>What is type of cuisine are you interested in trying for this trip?</div>
